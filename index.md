...
|  Fecha   | Sesion          |
|:---------|:--------------- |
| Feb 11     | `19`{: .fw-700 .fs-5} `Pruebas A/B`{: .fw-700 .fs-5} <br><br> _`Lecturas:`{: .fw-700 .fs-3}_[12](https://inferentialthinking.com/chapters/12/Comparing_Two_Samples.html)--[12.1](https://inferentialthinking.com/chapters/12/1/AB_Testing.html) <br><br>[Presentacion](https://docs.google.com/presentation/d/1TvpxqPEfdB4QsIw-vh56FaFMjIt7aCA6EkDRbBe1ztY/edit?usp=sharing){: .btn .float-left} [Demostracion](https://cdudea.org/hub/user-redirect/lab/tree/lab/semestre2024-2/lec/lec19/lec19.ipynb){: .btn .float-left}  <br><br><br><br>[Lab07: Pruebas A/B](https://cdudea.org/hub/user-redirect/lab/tree/lab/semestre2024-2/lab/lab07/lab07_.ipynb){: .label .label-green .float-left  }<br> `(Entrega Feb 19)`{: .label .label-yellow}|
...
|  Fecha   | Sesion          |
|:---------|:--------------- |
| Marzo 4   | `27`{: .fw-700 .fs-5} `Media muestral`{: .fw-700 .fs-5} <br><br> _`Lecturas:`{: .fw-700 .fs-3}_[14.5](https://inferentialthinking.com/chapters/14/5/Variability_of_the_Sample_Mean.html) <br><br>[Presentacion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} [Demostracion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} |
...
|  Fecha   | Sesion          |
|:---------|:--------------- |
|  Marzo 18    | `34`{: .fw-700 .fs-5} `Inferencia de regresión`{: .fw-700 .fs-5} <br><br> _`Lecturas:`{: .fw-700 .fs-3}_[16](https://inferentialthinking.com/chapters/16/Inference_for_Regression.html)--[16.1](https://inferentialthinking.com/chapters/16/1/Regression_Model.html)--[16.2](https://inferentialthinking.com/chapters/16/2/Inference_for_the_True_Slope.html)--[16.3](https://inferentialthinking.com/chapters/16/3/Prediction_Intervals.html) <br><br>[Presentacion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} [Demostracion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left}  <br><br>[Proyecto 02](https://cdudea.org/hub/user-redirect/lab/tree/lab/semestre2024-2/proyectos/proyecto02/project02.ipynb ){: .label .label-blue .float-left  } <br>`(Entrega Miercoles 26, 11:00am)`{: .label .label-yellow} <br><br>|
|  Marzo 20    | `34`{: .fw-700 .fs-5} `.....`{: .fw-700 .fs-5} <br><br> _`Lecturas:`{: .fw-700 .fs-3}_[16](https://inferentialthinking.com/chapters/16/Inference_for_Regression.html)--[16.1](https://inferentialthinking.com/chapters/16/1/Regression_Model.html)--[16.2](https://inferentialthinking.com/chapters/16/2/Inference_for_the_True_Slope.html)--[16.3](https://inferentialthinking.com/chapters/16/3/Prediction_Intervals.html) <br><br>[Presentacion](https://docs.google.com/presentation/d/1o4vlAbjsb66PaZzXjcpPR8y5fA-QIvcRWMDnMiMsYSY/edit?usp=sharing){: .btn .float-left}   <br><br>|
...
<!-- |Semana 17|
| Dic 25    | `36`{: .fw-700 .fs-5} `Clasificación`{: .fw-700 .fs-5} <br><br> _`Lecturas:`{: .fw-700 .fs-3}_[17](https://inferentialthinking.com/chapters/17/Classification.html)--[17.1](https://inferentialthinking.com/chapters/17/1/Nearest_Neighbors.html)--[17.2](https://inferentialthinking.com/chapters/17/2/Training_and_Testing.html)--[17.3](https://inferentialthinking.com/chapters/17/3/Rows_of_Tables.html) <br><br>[Presentacion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} [Demostracion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} [Video](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} <br><br>|
