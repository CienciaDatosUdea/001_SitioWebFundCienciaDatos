...
|  Fecha   | Sesion          |
|:---------|:--------------- |
|  Marzo 18    | `34`{: .fw-700 .fs-5} `Inferencia de regresión`{: .fw-700 .fs-5} <br><br> _`Lecturas:`{: .fw-700 .fs-3}_[16](https://inferentialthinking.com/chapters/16/Inference_for_Regression.html)--[16.1](https://inferentialthinking.com/chapters/16/1/Regression_Model.html)--[16.2](https://inferentialthinking.com/chapters/16/2/Inference_for_the_True_Slope.html)--[16.3](https://inferentialthinking.com/chapters/16/3/Prediction_Intervals.html) <br><br>[Presentacion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left} [Demostracion](https://inferentialthinking.com/chapters/01/what-is-data-science.html){: .btn .float-left}  <br><br>[Proyecto 02](https://cdudea.org/hub/user-redirect/lab/tree/lab/semestre2024-2/lab/proyectos/proyecto02/project02.ipynb ){: .label .label-blue .float-left  } <br>`(Entrega Nov 26)`{: .label .label-yellow} <br><br>|
